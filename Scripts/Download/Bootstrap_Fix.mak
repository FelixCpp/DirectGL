...
windows: windows-base
	devenv .\build\bootstrap\Premake5.slnx /Upgrade
	devenv .\build\bootstrap\Premake5.slnx /Build "$(CONFIG)|$(PLATFORM:x86=win32)"

windows-msbuild: windows-base
	msbuild /p:Configuration=$(CONFIG) /p:Platform=$(PLATFORM:x86=win32) .\build\bootstrap\Premake5.slnx
